...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
  ...
  <div class="row">
    <div class="col-lg-6">
    <form class="add-menu-form" action="{{url('cms/menu')}}" method="POST" autocomplete="off" novalidate="novalidate">
        @csrf
        <div class="form-group">
          <label for="page_name">* Page Name</label>
        <input value="{{old('page_name')}}" type="text" name="page_name" id="page_name" class="origin-field form-control">
